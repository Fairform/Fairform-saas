    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            We're a proudly independent company based in Australia. We're not here to maximize billable hours—we're here to help founders, operators, and teams do business with clarity, security, and speed. Compliance shouldn't slow you down—it should move with you.
          </p>
