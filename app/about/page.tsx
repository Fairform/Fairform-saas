      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              ...
              regardless of size or budget. That's why we built FairForm.
            </p>
          </motion.div>
        </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <div className="text-center border-t border-gray-200 pt-6">
                    ...
                    <div className="text-gray-600">Average time with FairForm</div>
                  </div>
                  <div className="text-center border-t border-gray-200 pt-6">
        ...
        <section className="py-20 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Ready to experience FairForm?
              </h2>
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                Join the hundreds of Australian businesses already using FairForm to simplify their compliance.
              </p>
