          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-red-700 mb-4">
                These Terms of Service constitute a legally binding agreement between you and FairForm Pty Ltd (ACN: [Company Number]). By accessing or using our Services, you acknowledge that you have read, understood, and agree to be bound by these terms and all applicable laws and regulations.
              </p>
        ...
        <div className="prose prose-lg max-w-none">
          <div className="space-y-10">
                ...
                <div className="space-y-4 text-sm text-gray-700">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p><strong>"Services"</strong> means all software, applications, platforms, websites, APIs, content, and related services provided by FairForm;</p>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-700 mb-4">
                      <strong>FairForm IS NOT A LAW FIRM and our Services DO NOT constitute legal, financial, accounting, or professional advice.</strong> The documents and information provided are for general informational purposes only and may not be suitable for your specific circumstances.
                    </p>
                    <p className="text-red-700">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                You agree to indemnify, defend, and hold harmless FairForm, its officers, directors, employees, agents, and contractors from and against all claims, damages, losses, costs, and expenses (including reasonable legal fees) arising from or relating to:
              </p>
              <ol className="list-decimal pl-6 text-gray-700 space-y-2 mb-6">
                ...
                <div className="space-y-4">
                  <div className="bg-green-50 border-l-4 border-green-500 p-4">
                    ...
                    <ul className="text-gray-700 text-sm space-y-1">
                      ...
                      <li>• Immediately for material breach by FairForm</li>
                      <li>• Upon completion of one-time purchases</li>
                    </ul>
                  </div>
                  
                  <div className="bg-orange-50 border-l-4 border-orange-500 p-4">
                    <h4 className="font-semibold text-gray-900 mb-2">Termination by FairForm</h4>
                    <ul className="text-gray-700 text-sm space-y-1">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-4 text-gray-700">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-1 text-sm">
                        <p><strong>Entity Name:</strong> FairForm Pty Ltd</p>
                    ...
                    <div>
                      ...
                      <div className="space-y-1 text-sm">
                        <p><strong>Email:</strong> legal@fairform.ai</p>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <p className="text-sm">
                      Legal documents may be served at the registered office address above or via email to legal@fairform.ai with confirmation of receipt. International users may serve process through the Australian Securities and Investments Commission (ASIC) or as otherwise permitted by law.
                    </p>
                  </div>
                </div>
              </div>
